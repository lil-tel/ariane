...
class CustomCanvas:
    ...
    def __init__(self, width, height=None, title=' '):
...
def cree_fenetre(largeur, hauteur = None, titre =''):
    """
    Crée une fenêtre de dimensions "largeur" x "hauteur" pixels.
    """
    global __canevas,__canevas2
    if __canevas is not None:
        if __canevas2 is not None:
            raise FenetreDejaCree(
                'La fenêtre a déjà été crée avec la fonction "cree_fenetre".')
        __canevas2 = CustomCanvas(largeur, hauteur or largeur,titre)
        return
    __canevas = CustomCanvas(largeur, hauteur or largeur, titre)


def ferme_fenetre(f=None):
    """
    Détruit la fenêtre.
    """
    global __canevas,__canevas2
    if f in {1,2}: i = f-1
        ...
        if __canevas2 is not None: ferme_fenetre(2)
        ferme_fenetre(1)
        return
    if (__canevas or __canevas2) is None:
        raise FenetreNonCree(
            "La fenêtre n'a pas été crée avec la fonction \"cree_fenetre\".")
    [__canevas,__canevas2][i].root.destroy()
    if i: __canevas2 = None
    else: __canevas = None
...
def mise_a_jour():
    ...
    if (__canevas or __canevas2) is None:
        raise FenetreNonCree(
            "La fenêtre n'a pas été crée avec la fonction \"cree_fenetre\".")
    if __canevas is not None: __canevas.update()
    if __canevas2 is not None: __canevas2.update()
...
def ligne(ax, ay, bx, by, couleur='black', epaisseur=1, tag='',f=None):
    """
    ...
    """
    global __canevas,__canevas2
    return (__canevas2 if(f==2) else __canevas).canvas.create_line(
        ax, ay, bx, by,
        fill=couleur,
        width=epaisseur,
        tag=tag)
...
def fleche(ax, ay, bx, by, couleur='black', epaisseur=1, tag='',f=None):
    """
    ...
    return (__canevas2 if(f==2) else __canevas).canvas.create_polygon(
        points, 
        fill=couleur, 
        outline=couleur,
        width=epaisseur,
...
def polygone(points, couleur='black', remplissage='', epaisseur=1, tag='',f=None):
    """
...
def rectangle(ax, ay, bx, by,
              couleur='black', remplissage='', epaisseur=1, tag='',f=None):
    """
    ...
    """
    global __canevas,__canevas2
    return (__canevas2 if(f==2) else __canevas).canvas.create_rectangle(
        ax, ay, bx, by,
        outline=couleur,
        fill=remplissage,
        width=epaisseur,
...
def cercle(x, y, r, couleur='black', remplissage='', epaisseur=1, tag='',f=None):
    """ 
    ...
    """
    global __canevas,__canevas2
    return (__canevas2 if(f==2) else __canevas).canvas.create_oval(
        x - r, y - r, x + r, y + r,
        outline=couleur,
        fill=remplissage,
        width=epaisseur,
...
def arc(x, y, r, ouverture=90, depart=0, couleur='black', remplissage='',
    ...
    """
    global __canevas,__canevas2
    return (__canevas2 if(f==2) else __canevas).canvas.create_arc(
        x - r, y - r, x + r, y + r,
        extent=ouverture,
        start=init,
        style=ARC,
...
def point(x, y, couleur='black', epaisseur=1, tag='',f=None):
    """
    ...
    return ligne(x, y, x + epaisseur, y + epaisseur,
                 couleur, epaisseur, tag, f)


# Marques

def marque(x, y, couleur="red",f=None):
    """
    ...
    global __canevas,__canevas2
    efface_marque()
    (__canevas2 if(f==2) else __canevas).marqueh = ligne(
        x - __canevas.tailleMarque, y,
        x + __canevas.tailleMarque, y, couleur, tag='marque')
    (__canevas2 if(f==2) else __canevas).marquev = ligne(
...
def image(x, y, fichier, ancrage='center', tag='',f=None):
    """
    ...
    img_object = (__canevas2 if(f==2) else __canevas).canvas.create_image(
        x, y, anchor=ancrage, image=img, tag=tag)
    (__img2 if(f==2) else __img)[img_object] = img
    return img_object
...
def texte(x, y, chaine,
          couleur='black', ancrage='nw', police="Purisa", taille=24, tag='',f=None):
    """
    ...
    """
    global __canevas,__canevas2
    (__canevas2 if(f==2) else __canevas).set_font(police, taille)
    return (__canevas2 if(f==2) else __canevas).canvas.create_text(
        x, y,
        text=chaine, font=(__canevas2 if(f==2) else __canevas).tkfont, tag=tag,
        fill=couleur, anchor=ancrage)


def longueur_texte(chaine,f=None):
    """
    ...
    """
    global __canevas,__canevas2
    return (__canevas2 if(f==2) else __canevas).tkfont.measure(chaine)


def hauteur_texte(f=None):
    """
    ...
    """
    global __canevas,__canevas2
    return (__canevas2 if(f==2) else __canevas).tkfont.height
...
def efface_tout(f=None):
    """
    Efface la fenêtre.
    """
    global __canevas,__canevas2
    global __img,__img2
    (__img2 if(f==2) else __img).clear()
    (__canevas2 if(f==2) else __canevas).canvas.delete("all")


def efface(objet,f=None):
    """
    ...
    """
    global __canevas,__canevas2
    if objet in (__img2 if(f==2) else __img):
        del (__img2 if(f==2) else __img)[objet]
    (__canevas2 if(f==2) else __canevas).canvas.delete(objet)


def efface_marque(f=None):
    """
...
def capture_ecran(file,f=None):
    """
    Fait une capture d'écran sauvegardée dans "file.png".
    """
    global __canevas,__canevas2
    (__canevas2 if(f==2) else __canevas).canvas.postscript(file=file + ".ps",
                        height=(__canevas2 if(f==2) else __canevas).height,
                        width=(__canevas2 if(f==2) else __canevas).width,
                                                        colormode="color")
    subprocess.call(
...
def donne_evenement(f=None):
    """ 
    Renvoie l'événement associé à la fenêtre.
    """
    global __canevas,__canevas2
    if (__canevas2 if(f==2) else __canevas) is None:
        raise FenetreNonCree(
            "La fenêtre n'a pas été crée avec la fonction \"cree_fenetre\".")
    if len((__canevas2 if(f==2) else __canevas).eventQueue) == 0:
        return "RAS", ""
    else:
        return (__canevas2 if(f==2) else __canevas).eventQueue.pop()
